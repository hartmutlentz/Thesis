...
set style line 1 lc rgb "#800000" lt 1 lw 3 # Cayenne
set style line 2 lc rgb "#666666" lt 1 lw 3 # Steel
set style line 3 lc rgb "#0a82cc" lt 1 lw 3 # light blue (Triade)
set style line 4 lc rgb "#b34112" lt 1 lw 3 # Orange (Compound)
...
############################################################
p "sir_single.txt" u 1:2 title 'Susceptible' ls 3,\
 'sir_single.txt' u 1:3 title 'Infected' ls 1,\
 'sir_single.txt' u 1:4 title 'Recovered' ls 2
