...
\hudissmetadata{%
    ...
    docsubject={Epidemiology in complex networks}, % subject of the thesis (used in the properties of the pdf-document)
    approvala={Prof. Dr. I. M. Sokolov, Humboldt-Universität zu Berlin}, % approvals: a-e
    approvalb={Prof. Dr. Dr. J. Kurths, Potsdam-Institut für Klimafolgenforschung},
    approvalc={Prof. Dr. B. Blasius, Carl von Ossietzky Universität, Oldenburg},
    % approvald={},
    % approvale={},
    ...
    keywordsde={Komplexes Netzwerk, Epidemiologie, zeitabhängiges Netzwerk, statistische Physik} % german keywords comma separated
}
