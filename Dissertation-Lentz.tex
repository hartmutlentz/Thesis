...
\hudissmetadata{%
    ...
    doctitle={Epidemic Paths in Static and Temporal Networks}, % title of the thesis
    ...
    % keywordsen={complex network, temporal network, epidemiology}, % english keywords comma separated
    % keywordsde={Komplexes Netzwerk, zeitabhängiges Netzwerk, Epidemiologie} % german keywords comma separated
}
