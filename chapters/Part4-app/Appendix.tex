...
\section{Centrality in the static livestock trade network}\label{sec:centrality_hit}
...
\caption{Equation \eqref{eq:q_max} (grey dashed line) reproduces the values from numerical simulations (red circles).
