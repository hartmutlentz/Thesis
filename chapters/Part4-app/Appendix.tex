...
Due to the sparsity of typical adjacency matrices, networks can be efficiently stored as \emph{edge lists}.
...
&(4,3) .
\end{align*}
Due to their human readable structure, edge lists are a very convenient format to store networks as text files.
