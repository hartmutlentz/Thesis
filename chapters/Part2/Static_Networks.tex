...
Nevertheless, it can be shown that the effect seen in figure \ref{fig:outbreaksize_vs_rec_ER} are not mixing effects of the SIR epidemic, but can in fact be explained by purely topological arguments \citep{Lentz:2012pre}.
...
\subsection{Impact of modularity}
We define the time of outbreak peak as follows.
