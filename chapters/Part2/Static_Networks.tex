...
The number of elements in the partition space is given by the so called \emph{bell number} counting the number of partitions of a set.
This means that the number of partitions of a network with 10 nodes is $\sim 10^5$ and it is already $\sim 10^{47}$ for 50 nodes!
