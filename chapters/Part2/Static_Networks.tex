...
In this chapter, we analyze the pig trade between agricultural holding in Germany as a static network.
The focus hereby lies the epidemic spreading potential of networks of this type.
...
Thereofre, modularity can be computed using a property matrix, where the properties are module labels.
