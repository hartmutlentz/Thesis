...
Epidemics have always been a serious issue for societies and therefore, the understanding and prediction of the spread of infectious diseases became an important factor of research.
...
Early attempts go back to the 18th century; in his review about the mathematics of infectious diseases, \citeauthor{Hethcote:2000} reports a model for smallpox was formulated in 1760 by D. Bernoulli (see \citet{Hethcote:2000} and references therein).
...
In particular, \citeauthor{kermack:27} found the existence of an epidemic threshold, i.e. a critical infection rate necessary to overcome the extinction of the epidemic \citep{kermack:27}.
...
Livestock trade network analysis provides support for the planning of surveillance and vaccination strategies in agriculture.
...
\citeauthor{euler:1736} solved the so-called seven bridges of Kšnigsberg problem by showing that there is no closed path using all edges of a network exactly once, if more than two nodes have an odd number of neighbors \citep{euler:1736}, say an odd degree.
...
Besides the temporal network model introduced by \citet{Tang:2010dn}, random walk models can be used in order generate synthetic temporal networks reproducing the bursty behavior of real-world datasets \citep{Barrat:2013da}.
