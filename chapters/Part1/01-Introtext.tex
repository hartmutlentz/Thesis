...
\end{itemize}
We address these questions in chapter~\ref{chap:static}, where we derive a model for infection dynamics on a network of meta populations connected by trade edges.
...
Due to the fluctuating appearance of edges, the non-causality of paths results in ubiquitous problems in temporal network analysis \citep{Casteights_review,Nicosia:2012hz}.
...
\end{itemize}
We address these questions in chapter~\ref{sec:temporal_networks}, where we introduce the novel method of unfolding accessibility for temporal networks.
