...
The modeling of infection diseases mostly uses the concept of compartment models as explained in sections \ref{sec:si_model} and \ref{sec:sir_model}.
...
In the following section we briefly report some properties of basic epidemic models following the lecture notes of J.~R.~Chasnov \citep{Chasnov:2010}.
