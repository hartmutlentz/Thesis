...
A Watts-Strogatz model interpolates between regular and random networks by rewiring edges of a lattice.
...
Exponential, Configuration, Attractiveness.

Das muss aber keine eigene Section haben.
