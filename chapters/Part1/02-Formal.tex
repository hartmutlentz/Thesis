...
A \emph{meta-population} is a set of subpopulations which are connected by migration processes \citep{dynamical_processes,Hanski:1998}.
Meta-population approaches have been used to model large scale disease outbreaks, such as influenza, SARS .
...
\end{equation}
The first term $R$ in equation \eqref{eq:general_metapop_sir} is a local reaction term, while the migration to other subpopulations could depend on the local distribution and the infection status of other subpopulations connected to $\mu $.
