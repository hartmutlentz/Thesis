...
\paragraph{Observations\color{Cayenne}{.}} Large scale patterns of epidemics have been measured \cite{geissel_der_menschheit}
...
This section addresses the properties of \emph{products} of adjacency matrices.
