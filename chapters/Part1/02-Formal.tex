...
One goal of epidemiology is to understand the principles behind the spreading process, i.e. the way how a disease is transmitted through a population.
...
The modeling of infection diseases makes extensive use of compartment models as explained in sections \ref{sec:si_model} and \ref{sec:sir_model}.
...
Before we formulate models for the spread of epidemic diseases, we have to differentiate between conceptional models and realistic disease models.
