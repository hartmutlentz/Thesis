...
\acro{}[$r_v(d,t_0)$]{Range of a node for memory/infectious period $d$ and starting time $t_0$. Equivalent to outbreak size for simple compartment models.}
\end{acronym}
